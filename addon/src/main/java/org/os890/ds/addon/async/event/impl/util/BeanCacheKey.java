...
public class BeanCacheKey
{
    ...
    public Annotation[] getQualifiers()
    {
        ...
        return new Annotation[]{this.qualifier};
    }
    ...
    private int getTypeHashCode(Type type)
    {
        ...
        if (typeHash == 0 && type instanceof Class)
        {
            ...
            // the beanClass.toString() is always the same: "java.lang.Class@<hexid>"
            // was: return beanClass.toString().hashCode();
        }
    ...
    {
        int computedHashCode = 31 * getTypeHashCode(beanClass);
        if (qualifier != null)
        {
    ...
    {
        return "BeanCacheKey{" + "beanClass=" + beanClass + ", qualifiers="
